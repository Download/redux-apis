...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Api', function () {
		...
		describe('.connector(state, ownProps)', function () {
			...
			it('is auto-bound to it\'s Api instance', function () {
				var myApi = new _reduxApis.Api({ state: 'OK' });
				var myApi2 = new _reduxApis.Api({ state: 'WRONG' });
			...
			it('returns an object with this Api\'s state, `ownProps` and this Api\'s enumerable properties spread into it, and an `api` property referencing this Api', function () {
				var myApi = new _reduxApis.Api({ state: 'OK' });
				myApi.enumerable = 'prop';
				var connect = myApi.connector;
				var test = connect({}, { own: 'prop' });
				(0, _chai.expect)(test).to.be.an('object');
				(0, _chai.expect)(test).to.have.a.property('state');
				(0, _chai.expect)(test.state).to.equal('OK');
				(0, _chai.expect)(test).to.have.a.property('own');
				(0, _chai.expect)(test.own).to.equal('prop');
				(0, _chai.expect)(test).to.have.a.property('enumerable');
				(0, _chai.expect)(test.enumerable).to.equal('prop');
				(0, _chai.expect)(test).to.have.a.property('api');
				(0, _chai.expect)(test.api).to.equal(myApi);
			});
	
			it('returns an object with sub-objects for nested Apis, that change identity when the nested Api\'s state changes.', function () {
				var SubApi = function (_Api22) {
					_inherits(SubApi, _Api22);
					...
					function SubApi() {
						...
						var _this22 = _possibleConstructorReturn(this, Object.getPrototypeOf(SubApi).call(this, state));
	
						_this22.setHandler('SET', function (state, _ref) {
							var payload = _ref.payload;
							return _extends({}, state, { value: payload });
						});
						Object.defineProperty(_this22, 'value', { enumerable: true, get: function get() {
								return _this22.getState().value;
							} });
						return _this22;
					}
				...
				var ApiWithSubs = function (_Api23) {
					_inherits(ApiWithSubs, _Api23);
	
					function ApiWithSubs(state) {
						_classCallCheck(this, ApiWithSubs);
	
						var _this23 = _possibleConstructorReturn(this, Object.getPrototypeOf(ApiWithSubs).call(this, state));
	
						_this23.sub = (0, _reduxApis.link)(_this23, new SubApi());
						return _this23;
					}
			...
			it('can be used in combination with the @connect decorator from react-redux', function () {
				...
				var MyApi = function (_Api24) {
					_inherits(MyApi, _Api24);
	...
	describe('link(parent, child, link/*(parentState,childState)*/ )', function () {
		it('can be used to link a child api to a parent api', function () {
			var SubApi = function (_Api25) {
				_inherits(SubApi, _Api25);
			...
			var MyApi = function (_Api26) {
				...
				function MyApi(state) {
					...
					var _this27 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this27.nested = (0, _reduxApis.link)(_this27, new SubApi());
					return _this27;
				}
		...
		it('results in actions on the child api to be dispatched via the parent api', function () {
			...
			var MyApi = function (_Api28) {
				...
				function MyApi(state) {
					...
					(0, _chai.expect)(_this29.nested).to.be.an.instanceOf(SubApi);
					return _this29;
				}
		...
		it('accepts an optional `link` function to link the child state to the parent state', function () {
			...
			var MyApi = function (_Api30) {
				...
				function MyApi(state) {
					...
					_this31.nested = (0, _reduxApis.link)(_this31, new SubApi(), function (state, subState) {
		...
		it('can be used to link an api to a redux store', function () {
			...
			var MyApi = function (_Api32) {
				...
				function MyApi(state) {
					...
					_this33.reducerCalled = 0;
					_this33.nested = (0, _reduxApis.link)(_this33, new SubApi());
					_this33.setHandler('TEST', function (state, action) {
		...
		it('can be used to index state objects into a parent array', function () {
			...
			var MyApi = function (_Api33) {
				...
				function MyApi() {
					...
					_this34.first = (0, _reduxApis.link)(_this34, new _reduxApis.Api('1st'), indexLink(0));
					_this34.second = (0, _reduxApis.link)(_this34, new _reduxApis.Api('2nd'), indexLink(1));
					_this34.third = (0, _reduxApis.link)(_this34, new _reduxApis.Api('3rd'), indexLink(2));
					return _this34;
				}
	...
	describe('apiLink(parentState, childState)', function () {
		it('is used as the default link from a child api to a parent api', function () {
			var SubApi = function (_Api34) {
				_inherits(SubApi, _Api34);
			...
			var MyApi = function (_Api35) {
				...
				function MyApi(state) {
					...
					_this36.nested = (0, _reduxApis.link)(_this36, new SubApi());
					return _this36;
				}
		...
		it('it can be used to customize the state link between a parent and child api', function () {
			...
			var MyApi = function (_Api37) {
				...
				function MyApi() {
					...
					_this38.nested = (0, _reduxApis.link)(_this38, new SubApi(), customLink);
					return _this38;
				}
