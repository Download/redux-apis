...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxApis = __webpack_require__(218);
	...
	describe('Api', function () {
		it('is a class that serves as a base class for redux-aware API\'s', function () {
			(0, _chai.expect)(_reduxApis.Api).to.not.equal(undefined);
			(0, _chai.expect)(_reduxApis.Api).to.be.a('function');
	
			var MyApi = function (_Api) {
				_inherits(MyApi, _Api);
	
				function MyApi() {
					_classCallCheck(this, MyApi);
	
					return _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).apply(this, arguments));
				}
			...
			;
			(0, _chai.expect)(MyApi.prototype).to.be.an.instanceOf(_reduxApis.Api);
			(0, _chai.expect)(Object.keys(new _reduxApis.Api()).length).to.equal(0);
		});
	
		describe('.constructor(state)', function () {
			it('can be called without arguments', function () {
				var myApi = new _reduxApis.Api();
				(0, _chai.expect)(myApi).to.be.an.instanceOf(_reduxApis.Api);
				(0, _chai.expect)(myApi).to.have.a.property('getState');
				(0, _chai.expect)(myApi.getState).to.be.a('function');
			});
	
			it('results in `getState` returning the default value for the `state` parameter', function () {
				var myApi = new _reduxApis.Api();
				(0, _chai.expect)(myApi.getState()).to.be.an('object');
			});
	
			it('can be called with some state slice', function () {
				var myApi = new _reduxApis.Api({ my: 'state' });
				(0, _chai.expect)(myApi).to.be.an.instanceOf(_reduxApis.Api);
			});
	
			it('results in `getState` returning the given state slice', function () {
				var myApi = new _reduxApis.Api({ my: 'state' });
				(0, _chai.expect)(myApi.getState()).to.have.a.property('my');
				(0, _chai.expect)(myApi.getState().my).to.equal('state');
			});
		});
	
		describe('.init()', function () {
			var dispatched = false;
			var initialStateCalled = 0;
	
			var Nested = function (_Api2) {
				_inherits(Nested, _Api2);
	
				function Nested() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? 'NESTED' : arguments[0];
	
					_classCallCheck(this, Nested);
	
					return _possibleConstructorReturn(this, Object.getPrototypeOf(Nested).call(this, state));
				}
	
				return Nested;
			}(_reduxApis.Api);
	
			var MyApi = function (_Api3) {
				_inherits(MyApi, _Api3);
	
				function MyApi() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? { my: 'state' } : arguments[0];
	
					_classCallCheck(this, MyApi);
	
					var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this3.nested = (0, _reduxApis.link)(_this3, new Nested());
					return _this3;
				}
				...
				_createClass(MyApi, [{
					...
					value: function dispatch(action) {
						(0, _chai.expect)(action.type).to.equal('@@redux/INIT');
						dispatched = true;
						return _get(Object.getPrototypeOf(MyApi.prototype), 'dispatch', this).call(this, action);
					}
				}]);
			...
			it('can be used to manually initialize the state tree', function () {
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.init).to.be.a('function');
			});
	
			it('dispatches a redux INIT action to this state tree', function () {
				var myApi = new MyApi();
				(0, _chai.expect)(dispatched).to.equal(false);
				myApi.init();
				(0, _chai.expect)(dispatched).to.equal(true);
			});
	
			it('returns `this` to allow for chaining', function () {
				var myApi = new MyApi();
				var returned = myApi.init();
				(0, _chai.expect)(returned).to.equal(myApi);
			});
	
			it('results in `getState` returning the initial state', function () {
				var myApi = new MyApi().init();
				(0, _chai.expect)(myApi).to.have.a.property('getState');
				(0, _chai.expect)(myApi.getState).to.be.a('function');
				(0, _chai.expect)(myApi.getState()).to.have.a.property('my');
				(0, _chai.expect)(myApi.getState().my).to.equal('state');
				(0, _chai.expect)(myApi.getState()).to.have.a.property('nested');
				(0, _chai.expect)(myApi.getState().nested).to.equal('NESTED');
			});
	
			it('does not have to be called when using redux', function () {
				var myApi = new MyApi();
				var store = (0, _redux.createStore)(myApi.reducer);
				(0, _reduxApis.link)(store, myApi);
				(0, _chai.expect)(myApi).to.have.a.property('getState');
				(0, _chai.expect)(myApi.getState).to.be.a('function');
				(0, _chai.expect)(myApi.getState()).to.have.a.property('my');
				(0, _chai.expect)(myApi.getState().my).to.equal('state');
		...
		describe('.getState()', function () {
			var MyApi = function (_Api4) {
				_inherits(MyApi, _Api4);
	
				function MyApi() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? { initial: 'state' } : arguments[0];
	
					_classCallCheck(this, MyApi);
	
					return _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
				}
	
				return MyApi;
			}(_reduxApis.Api);
	
			it('is a function available on instances of Api', function () {
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.getState).to.be.a('function');
			});
	
			it('returns the current state for the Api object', function () {
				var api1 = new MyApi();
				var state1 = api1.getState();
				(0, _chai.expect)(state1).to.be.an('object');
				(0, _chai.expect)(state1).to.have.a.property('initial');
				(0, _chai.expect)(state1.initial).to.equal('state');
				var api2 = new MyApi({ initial: 'custom' });
				var state2 = api2.getState();
				(0, _chai.expect)(state2.initial).to.equal('custom');
			});
		});
	
		describe('.getParent()', function () {
			var MyApi = function (_Api5) {
				_inherits(MyApi, _Api5);
			...
			it('is a function available on instances of Api', function () {
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.getParent).to.be.a('function');
			});
	
			it('returns the parent of the Api object', function () {
				var Root = function (_Api6) {
					_inherits(Root, _Api6);
	
					function Root(state) {
						_classCallCheck(this, Root);
	
						var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(Root).call(this, state));
	
						_this6.sub = (0, _reduxApis.link)(_this6, new MyApi());
						return _this6;
					}
				...
				var root = new Root().init();
				(0, _chai.expect)(root).to.have.a.property('getParent');
				(0, _chai.expect)(root.getParent).to.be.a('function');
				(0, _chai.expect)(root.sub).to.be.an('object');
				(0, _chai.expect)(root.sub).to.have.a.property('getParent');
				(0, _chai.expect)(root.sub.getParent).to.be.a('function');
				(0, _chai.expect)(root.getParent()).to.equal(undefined);
				(0, _chai.expect)(root.sub.getParent()).to.equal(root);
			});
		});
	
		describe('.setHandler(actionType, handler/*(state,action)*/ )', function () {
			it('is a function available on instances of Api', function () {
				var MyApi = function (_Api7) {
					_inherits(MyApi, _Api7);
				...
				;
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.setHandler).to.be.a('function');
			});
	
			it('accepts an action type and a handler function', function () {
				var MyApi = function (_Api8) {
					_inherits(MyApi, _Api8);
				...
				(0, _chai.expect)(myApi.__actionHandlers['TEST']).to.be.a('function');
			});
	
			it('results in the handler being called when an action of the given type is dispatched', function () {
				var called = false;
	
				var MyApi = function (_Api9) {
					_inherits(MyApi, _Api9);
			...
			it('results in the handler being passed the current state and action when called', function () {
				var called = false;
	
				var MyApi = function (_Api10) {
					_inherits(MyApi, _Api10);
				...
				;
				var myApi = new MyApi({ my: 'state' });
				myApi.setHandler('TEST', function (state, action) {
					(0, _chai.expect)(state).to.be.an('object');
					(0, _chai.expect)(state).to.have.a.property('my');
					(0, _chai.expect)(state.my).to.equal('state');
					(0, _chai.expect)(action).to.be.an('object');
					(0, _chai.expect)(action).to.have.a.property('type');
					(0, _chai.expect)(action.type).to.equal('TEST');
					called = true;
				});
				myApi.dispatch(myApi.createAction('TEST')());
				(0, _chai.expect)(called).to.equal(true);
		...
		describe('.getHandler(actionType)', function () {
			it('is a function available on instances of Api', function () {
				var MyApi = function (_Api11) {
					_inherits(MyApi, _Api11);
				...
				;
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.getHandler).to.be.a('function');
			});
	
			it('accepts an action type and returns any handler set for that action type', function () {
				var MyApi = function (_Api12) {
					_inherits(MyApi, _Api12);
			...
			it('returns `undefined` when no handler was set for the given action type', function () {
				var MyApi = function (_Api13) {
					_inherits(MyApi, _Api13);
				...
				;
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.getHandler('TEST')).to.equal(undefined);
			});
		});
	
		describe('.clearHandler(actionType)', function () {
			var MyApi = function (_Api14) {
				_inherits(MyApi, _Api14);
			...
			it('is a function available on instances of Api', function () {
				(0, _chai.expect)(myApi.clearHandler).to.be.a('function');
			});
	
			it('accepts an action type', function () {
				myApi.clearHandler('TEST');
			});
	
			it('results in no handler to be registered anymore for the given action type', function () {
				(0, _chai.expect)(myApi.__actionHandlers['TEST']).to.equal(undefined);
			});
		});
	
		describe('.createAction(actionType, payloadCreator, metaCreator', function () {
			var MyApi = function (_Api15) {
				_inherits(MyApi, _Api15);
			...
			var MyComplexApi = function (_Api16) {
				_inherits(MyComplexApi, _Api16);
	
				function MyComplexApi() {
					var _Object$getPrototypeO;
	
					_classCallCheck(this, MyComplexApi);
	
					for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
						args[_key] = arguments[_key];
					}
	
					var _this16 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(MyComplexApi)).call.apply(_Object$getPrototypeO, [this].concat(args)));
	
					_this16.nested = (0, _reduxApis.link)(_this16, new MyApi());
					return _this16;
				}
			...
			var myApi = new MyApi();
			var myComplexApi = new MyComplexApi();
	
			it('is a function available on instances of Api', function () {
				(0, _chai.expect)(myApi.createAction).to.be.a('function');
				(0, _chai.expect)(myComplexApi.createAction).to.be.a('function');
			});
	
			it('creates a function that will create actions of the given action type', function () {
				var test = myApi.createAction('TEST');
				(0, _chai.expect)(test).to.not.equal(undefined);
				(0, _chai.expect)(test).to.be.a('function');
				var action = test({ my: 'action' });
				(0, _chai.expect)(action).to.be.an('object');
				(0, _chai.expect)(action).to.have.a.property('type');
				(0, _chai.expect)(action.type).to.equal('TEST');
				(0, _chai.expect)(action).to.have.a.property('payload');
				(0, _chai.expect)(action.payload).to.be.an('object');
				(0, _chai.expect)(action.payload).to.have.a.property('my');
				(0, _chai.expect)(action.payload.my).to.equal('action');
			});
	
			it('applies namespaces to the action type based on the Api hierarchy', function () {
				var test = myComplexApi.nested.createAction('TEST');
				var action = test({ my: 'action' });
				(0, _chai.expect)(action.type).to.equal('nested/TEST');
			});
	
			it('accepts optional actionCreator and metaCreator functions', function () {
				var actionCreatorCalled = false;
				function actionCreator() {
					actionCreatorCalled = true;
				}
				var metaCreatorCalled = false;
				function metaCreator() {
					metaCreatorCalled = true;
				}
				var test = myApi.createAction('TEST', actionCreator, metaCreator);
				var action = test({ my: 'action' });
				(0, _chai.expect)(actionCreatorCalled).to.equal(true);
				(0, _chai.expect)(metaCreatorCalled).to.equal(true);
			});
		});
	
		describe('.dispatch(action)', function () {
			it('is a function available on instances of Api', function () {
				var MyApi = function (_Api17) {
					_inherits(MyApi, _Api17);
				...
				;
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.dispatch).to.be.a('function');
			});
	
			it('dispatches an action to the root of the Api tree', function () {});
		});
	
		describe('.reducer(state, action)', function () {
			it('is a function available on instances of Api', function () {
				var MyApi = function (_Api18) {
					_inherits(MyApi, _Api18);
				...
				;
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.reducer).to.be.a('function');
			});
	
			it('is auto-bound to it\'s Api instance', function () {
				var boundInstance = null;
	
				var MyApi = function (_Api19) {
					_inherits(MyApi, _Api19);
					...
					_createClass(MyApi, [{
						...
						value: function reducer() {
							...
							(_get2 = _get(Object.getPrototypeOf(MyApi.prototype), 'reducer', this)).call.apply(_get2, [this].concat(args));
						}
					}]);
				...
				(0, _chai.expect)(boundInstance).to.be.an('object');
				(0, _chai.expect)(boundInstance).to.be.an.instanceof(_reduxApis.Api);
				(0, _chai.expect)(boundInstance).to.equal(myApi);
			});
	
			it('is called for each action that is dispatched to this api tree', function () {
				var called = false;
	
				var MyApi = function (_Api20) {
					_inherits(MyApi, _Api20);
					...
					_createClass(MyApi, [{
						...
						value: function reducer(state, action) {
							(0, _chai.expect)(action).to.not.equal(undefined);
							(0, _chai.expect)(action).to.have.a.property('type');
							(0, _chai.expect)(action.type).to.equal('TEST');
							called = true;
							_get(Object.getPrototypeOf(MyApi.prototype), 'reducer', this).call(this, state, action);
						}
					}]);
				...
				;
				var myApi = new MyApi();
				(0, _chai.expect)(called).to.equal(false);
				myApi.dispatch(myApi.createAction('TEST')());
				(0, _chai.expect)(called).to.equal(true);
			});
	
			it('looks for an action handler for the action and invokes it if found', function () {
				var handlerCalled = false;
	
				var MyApi = function (_Api21) {
					_inherits(MyApi, _Api21);
	
					function MyApi(state) {
						_classCallCheck(this, MyApi);
	
						var _this21 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
						_this21.setHandler('CALL', function (state, action) {
							handlerCalled = true;
							return _extends({}, state, { msg: action.payload });
						});
						return _this21;
					}
				...
				(0, _chai.expect)(handlerCalled).to.equal(true);
				(0, _chai.expect)(myApi.getState()).to.have.a.property('msg');
				(0, _chai.expect)(myApi.getState().msg).to.equal('Some message');
			});
	
			it('returns the initial state for the Api object when given state is undefined', function () {
				var MyApi = function (_Api22) {
					_inherits(MyApi, _Api22);
					...
					function MyApi() {
						...
						var _this22 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
						_this22.setHandler('SET', function (state, action) {
				...
				var api = new MyApi().init();
				var state1 = api.getState();
				(0, _chai.expect)(state1).to.be.an('object');
				(0, _chai.expect)(state1).to.have.a.property('initial');
				(0, _chai.expect)(state1.initial).to.equal('state');
				api.set({ initial: 'changed' });
				var state2 = api.getState();
				(0, _chai.expect)(state2.initial).to.equal('changed');
				var state3 = api.reducer(undefined, { type: 'unknown' });
				(0, _chai.expect)(state3.initial).to.equal('state');
			});
		});
	
		describe('.connector(state, ownProps)', function () {
			var MyApi = function (_Api23) {
				_inherits(MyApi, _Api23);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this23 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					Object.defineProperty(_this23, 'state', { enumerable: true,
						get: function get() {
							return _this23.getState().state;
						}
					});
					return _this23;
				}
			...
			it('is a function available on instances of Api', function () {
				var myApi = new MyApi();
				(0, _chai.expect)(myApi.connector).to.be.a('function');
			});
	
			it('is auto-bound to it\'s Api instance', function () {
				var myApi = new MyApi({ state: 'OK' });
				var myApi2 = new MyApi({ state: 'WRONG' });
				var test = myApi.connector.bind(myApi2)();
				(0, _chai.expect)(test).to.be.an('object');
				(0, _chai.expect)(test).to.have.a.property('state');
				(0, _chai.expect)(test.state).to.equal('OK');
			});
	
			it('returns an object with this Api\'s enumerable properties spread into it', function () {
				var myApi = new MyApi({ state: 'OK' });
				myApi.enumerable = 'prop';
				var test = myApi.connector();
				(0, _chai.expect)(test).to.be.an('object');
				(0, _chai.expect)(test).to.have.a.property('state');
				(0, _chai.expect)(test.state).to.equal('OK');
				(0, _chai.expect)(test).to.have.a.property('enumerable');
				(0, _chai.expect)(test.enumerable).to.equal('prop');
			});
	
			it('returns an object with sub-objects for nested Apis, that change identity when the nested Api\'s state changes.', function () {
				var SubApi = function (_Api24) {
					_inherits(SubApi, _Api24);
	
					function SubApi() {
						var state = arguments.length <= 0 || arguments[0] === undefined ? { value: '' } : arguments[0];
	
						_classCallCheck(this, SubApi);
	
						var _this24 = _possibleConstructorReturn(this, Object.getPrototypeOf(SubApi).call(this, state));
	
						_this24.setHandler('SET', function (state, _ref) {
							var payload = _ref.payload;
							return _extends({}, state, { value: payload });
						});
						Object.defineProperty(_this24, 'value', { enumerable: true, get: function get() {
								return _this24.getState().value;
							} });
						return _this24;
					}
				...
				var ApiWithSubs = function (_Api25) {
					_inherits(ApiWithSubs, _Api25);
	
					function ApiWithSubs(state) {
						_classCallCheck(this, ApiWithSubs);
	
						var _this25 = _possibleConstructorReturn(this, Object.getPrototypeOf(ApiWithSubs).call(this, state));
	
						_this25.sub = (0, _reduxApis.link)(_this25, new SubApi());
						return _this25;
					}
				...
				var myApi = new ApiWithSubs().init();
				var prev = myApi.connector();
				var curr = myApi.connector();
				(0, _chai.expect)(curr).to.equal(prev);
				(0, _chai.expect)(curr.sub).to.equal(prev.sub);
				myApi.sub.set('test');
				curr = myApi.connector();
				(0, _chai.expect)(curr).to.not.equal(prev);
				(0, _chai.expect)(curr.sub).to.not.equal(prev.sub);
			});
	
			it('can be used in combination with the @connect decorator from react-redux', function () {
				var _dec, _class;
	
				var MyApi = function (_Api26) {
					_inherits(MyApi, _Api26);
	
					function MyApi() {
						var state = arguments.length <= 0 || arguments[0] === undefined ? { message: 'Hello, World!' } : arguments[0];
	
						_classCallCheck(this, MyApi);
	
						var _this26 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
						Object.defineProperty(_this26, 'message', { enumerable: true,
							get: function get() {
								return _this26.getState().message;
							}
						});
						return _this26;
					}
				...
				var App = (_dec = (0, _reactRedux.connect)(app.connector), _dec(_class = function (_Component) {
				...
				_picolog2.default.info(markup);
				(0, _chai.expect)(markup).to.contain('Hello, World!');
			});
		});
	});
	
	describe('link(parent, child, link/*(parentState,childState)*/ )', function () {
		it('can be used to link a child api to a parent api', function () {
			var SubApi = function (_Api27) {
				_inherits(SubApi, _Api27);
	
				function SubApi() {
					_classCallCheck(this, SubApi);
	
					return _possibleConstructorReturn(this, Object.getPrototypeOf(SubApi).apply(this, arguments));
				}
			...
			var MyApi = function (_Api28) {
				_inherits(MyApi, _Api28);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this29 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this29.nested = (0, _reduxApis.link)(_this29, new SubApi());
					return _this29;
				}
			...
			;
			var myApi = new MyApi({ nested: 'test' });
			(0, _chai.expect)(myApi).to.have.a.property('nested');
			(0, _chai.expect)(myApi.nested.getState()).to.equal('test');
		});
	
		it('results in actions on the child api to be dispatched via the parent api', function () {
			var dispatchCalled = false;
	
			var SubApi = function (_Api29) {
				_inherits(SubApi, _Api29);
				...
				_createClass(SubApi, [{
					key: 'test',
					value: function test() {
						this.dispatch(this.createAction('TEST')());
					}
				}]);
			...
			var MyApi = function (_Api30) {
				_inherits(MyApi, _Api30);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this31 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this31.nested = (0, _reduxApis.link)(_this31, new SubApi());
					(0, _chai.expect)(_this31.nested).to.be.an.instanceOf(SubApi);
					return _this31;
				}
			...
			var myApi = new MyApi({ nested: 'test' });
			myApi.nested.test();
			(0, _chai.expect)(dispatchCalled).to.equal(true);
		});
	
		it('accepts an optional `link` function to link the child state to the parent state', function () {
			var SubApi = function (_Api31) {
				_inherits(SubApi, _Api31);
			...
			var MyApi = function (_Api32) {
				_inherits(MyApi, _Api32);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this33 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this33.nested = (0, _reduxApis.link)(_this33, new SubApi(), function (state, subState) {
						return subState ? state.custom = subState : state.custom;
					});
					return _this33;
				}
			...
			;
			var expected = 'wow a custom state link!';
			var myApi = new MyApi({ custom: expected });
			(0, _chai.expect)(myApi).to.have.a.property('nested');
			(0, _chai.expect)(myApi.nested).to.be.an.instanceOf(SubApi);
			(0, _chai.expect)(myApi.nested.getState()).to.equal(expected);
		});
	
		it('can be used to link an api to a redux store', function () {
			var SubApi = function (_Api33) {
				_inherits(SubApi, _Api33);
	
				function SubApi() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? { sub: 'api' } : arguments[0];
	
					_classCallCheck(this, SubApi);
	
					return _possibleConstructorReturn(this, Object.getPrototypeOf(SubApi).call(this, state));
				}
			...
			var MyApi = function (_Api34) {
				_inherits(MyApi, _Api34);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this35 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this35.reducerCalled = 0;
					_this35.nested = (0, _reduxApis.link)(_this35, new SubApi());
					_this35.setHandler('TEST', function (state, action) {
						return _extends({}, state, { test: action.payload });
					});
					return _this35;
				}
				...
				_createClass(MyApi, [{
					...
					value: function reducer(state, action) {
						this.reducerCalled++;
						return _get(Object.getPrototypeOf(MyApi.prototype), 'reducer', this).call(this, state, action);
					}
				}]);
			...
			;
			var myApi = new MyApi();
			(0, _chai.expect)(myApi.reducerCalled).to.equal(0);
			var store = (0, _redux.createStore)(myApi.reducer, { custom: 'state' });
			(0, _reduxApis.link)(store, myApi);
			(0, _chai.expect)(store).to.be.an('object');
			(0, _chai.expect)(store.getState()).to.have.a.property('nested');
			(0, _chai.expect)(store.getState().nested).to.have.a.property('sub');
			(0, _chai.expect)(store.getState().nested.sub).to.equal('api');
			(0, _chai.expect)(myApi.reducerCalled).to.equal(1);
			myApi.test('MESSAGE');
			(0, _chai.expect)(myApi.reducerCalled).to.equal(2);
			(0, _chai.expect)(store.getState()).to.have.a.property('test');
			(0, _chai.expect)(store.getState().test).to.equal('MESSAGE');
			(0, _chai.expect)(store.getState().test).to.equal(myApi.getState().test);
	
			myApi = new MyApi();
			(0, _chai.expect)(myApi.reducerCalled).to.equal(0);
			store = (0, _redux.createStore)(myApi.reducer, { nested: 'test' });
			(0, _reduxApis.link)(store, myApi);
			(0, _chai.expect)(store.getState()).to.have.a.property('nested');
			(0, _chai.expect)(store.getState().nested).to.equal('test');
			(0, _chai.expect)(myApi.nested.getState()).to.equal('test');
			myApi.test('MESSAGE');
			(0, _chai.expect)(myApi.reducerCalled).to.equal(2);
			(0, _chai.expect)(store.getState()).to.have.a.property('test');
		...
		it('can be used to index state objects into a parent array', function () {
			var indexLink = function indexLink(idx) {
				return function (parentState, childState) {
					return childState ? parentState[idx] = childState : parentState[idx];
				};
			};
	
			var MyApi = function (_Api35) {
				_inherits(MyApi, _Api35);
				...
				function MyApi() {
					...
					var _this36 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this36.first = (0, _reduxApis.link)(_this36, new _reduxApis.Api('1st'), indexLink(0));
					_this36.second = (0, _reduxApis.link)(_this36, new _reduxApis.Api('2nd'), indexLink(1));
					_this36.third = (0, _reduxApis.link)(_this36, new _reduxApis.Api('3rd'), indexLink(2));
					return _this36;
				}
				...
				_createClass(MyApi, [{
					key: 'init',
					value: function init() {
						this.dispatch(this.createAction('@@redux/INIT')());return this;
					}
				}]);
			...
			var myApi = new MyApi().init();
			(0, _chai.expect)(myApi.getState()).to.be.an.instanceOf(Array);
			(0, _chai.expect)(myApi.getState()[0]).to.equal('1st');
			(0, _chai.expect)(myApi.getState()[1]).to.equal('2nd');
			(0, _chai.expect)(myApi.getState()[2]).to.equal('3rd');
		});
	});
	
	describe('apiLink(parentState, childState)', function () {
		it('is used as the default link from a child api to a parent api', function () {
			var SubApi = function (_Api36) {
				_inherits(SubApi, _Api36);
			...
			var MyApi = function (_Api37) {
				_inherits(MyApi, _Api37);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this38 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this38.nested = (0, _reduxApis.link)(_this38, new SubApi());
					return _this38;
				}
			...
			var myApi = new MyApi({ nested: 'test' });
			(0, _chai.expect)(myApi).to.have.a.property('nested');
			(0, _chai.expect)(myApi.nested).to.have.a.property('__link');
			(0, _chai.expect)(myApi.nested.__link).to.be.a('function');
			(0, _chai.expect)(myApi.nested.getState()).to.equal('test');
		});
	});
	
	describe('namedLink(name)', function () {
		it('it can be used to create a linker function to pass to `link`', function () {
			var customLink = (0, _reduxApis.namedLink)('custom');
			(0, _chai.expect)(customLink).to.be.a('function');
		});
	
		it('it returns a function that gets the state slice with the given name', function () {
			var customLink = (0, _reduxApis.namedLink)('custom');
			var test = customLink({ custom: 'test' });
			(0, _chai.expect)(test).to.equal('test');
		});
	
		it('it can be used to customize the state link between a parent and child api', function () {
			var customLink = (0, _reduxApis.namedLink)('custom');
	
			var SubApi = function (_Api38) {
				_inherits(SubApi, _Api38);
			...
			var MyApi = function (_Api39) {
				_inherits(MyApi, _Api39);
	
				function MyApi() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? { custom: 'test' } : arguments[0];
	
					_classCallCheck(this, MyApi);
	
					var _this40 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this40.nested = (0, _reduxApis.link)(_this40, new SubApi(), customLink);
					return _this40;
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hoistStatics = __webpack_require__(216);
	...
	var Api = exports.Api = function () {
		function Api() {
			...
			Object.defineProperties(this, {
				...
				__getState: { value: function value() {
						return state;
					} },
		...
		_createClass(Api, [{
			...
			value: function reducer(state, action) {
				...
				var result = this.__actionHandlers[action.type] ? this.__actionHandlers[action.type].call(this, state, action) : state === undefined ? this.__initialState : undefined;
...
/***/ }
/******/ ]);
//# sourceMappingURL=redux-apis.spec.js.map