		...
		it('can be used to link a child api to a parent api', function () {
			...
			var MyApi = function (_Api24) {
				...
				function MyApi(state) {
					...
					_this25.nested = (0, _reduxApis.link)(_this25, new SubApi());
					return _this25;
				}
		...
		it('results in actions on the child api to be dispatched via the parent api', function () {
			...
			var MyApi = function (_Api26) {
				...
				function MyApi(state) {
					...
					(0, _chai.expect)(_this27.nested).to.be.an.instanceOf(SubApi);
					return _this27;
				}
		...
		it('accepts an optional `link` function to link the child state to the parent state', function () {
			...
			var MyApi = function (_Api28) {
				...
				function MyApi(state) {
					...
					_this29.nested = (0, _reduxApis.link)(_this29, new SubApi(), function (state, subState) {
		...
		it('can be used to link an api to a redux store', function () {
			...
			var MyApi = function (_Api30) {
				...
				function MyApi(state) {
					...
					_this31.reducerCalled = 0;
					_this31.nested = (0, _reduxApis.link)(_this31, new SubApi());
					_this31.setHandler('TEST', function (state, action) {
		...
		it('can be used to index state objects into a parent array', function () {
			...
			var MyApi = function (_Api31) {
				...
				function MyApi() {
					...
					_this32.first = (0, _reduxApis.link)(_this32, new _reduxApis.Api('1st'), indexLink(0));
					_this32.second = (0, _reduxApis.link)(_this32, new _reduxApis.Api('2nd'), indexLink(1));
					_this32.third = (0, _reduxApis.link)(_this32, new _reduxApis.Api('3rd'), indexLink(2));
					return _this32;
				}
		...
		it('it can be used to customize the state link between a parent and child api', function () {
			...
			var MyApi = function (_Api35) {
				...
				function MyApi() {
					...
					_this36.nested = (0, _reduxApis.link)(_this36, new SubApi(), customLink);
					return _this36;
				}
	...
	var Api = exports.Api = function () {
		...
		_createClass(Api, [{
			...
			value: function connector(state, ownProps) {
				return _extends({}, ownProps, this.getState(), { api: this }, this);
			}
		}]);
