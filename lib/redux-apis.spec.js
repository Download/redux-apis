...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Api', function () {
		...
		describe('.setHandler(actionType, handler/*(state,action)*/ )', function () {
			...
			it('results in the handler being called when an action of the given type is dispatched', function () {
				...
				var MyApi = function (_Api6) {
					_inherits(MyApi, _Api6);
		...
		describe('.createAction(actionType, payloadCreator, metaCreator', function () {
			...
			var MyComplexApi = function (_Api10) {
				_inherits(MyComplexApi, _Api10);
				...
				function MyComplexApi() {
					...
					var _this10 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(MyComplexApi)).call.apply(_Object$getPrototypeO, [this].concat(args)));
	
					_this10.nested = (0, _reduxApis.link)(_this10, new MyApi());
					return _this10;
				}
		...
		describe('.reducer(state, action)', function () {
			...
			it('looks for an action handler for the action and invokes it if found', function () {
				...
				var MyApi = function (_Api16) {
					_inherits(MyApi, _Api16);
	
					function MyApi(state) {
						_classCallCheck(this, MyApi);
	
						var _this17 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
						_this17.setHandler('CALL', function (state, action) {
							handlerCalled = true;
	...
	describe('link(parent, child, link/*(parentState,childState)*/ )', function () {
		it('can be used to link a child api to a parent api', function () {
			var SubApi = function (_Api17) {
				_inherits(SubApi, _Api17);
			...
			var MyApi = function (_Api18) {
				...
				function MyApi(state) {
					...
					var _this19 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this19.nested = (0, _reduxApis.link)(_this19, new SubApi());
					return _this19;
				}
		...
		it('results in actions on the child api to be dispatched via the parent api', function () {
			...
			var SubApi = function (_Api19) {
				_inherits(SubApi, _Api19);
			...
			var MyApi = function (_Api20) {
				...
				function MyApi(state) {
					...
					_this21.nested = (0, _reduxApis.link)(_this21, new SubApi());
					(0, _chai.expect)(_this21.nested).to.be.an.instanceOf(SubApi);
					return _this21;
				}
		...
		it('accepts an optional `link` function to link the child state to the parent state', function () {
			var SubApi = function (_Api21) {
				_inherits(SubApi, _Api21);
			...
			var MyApi = function (_Api22) {
				...
				function MyApi(state) {
					...
					_this23.nested = (0, _reduxApis.link)(_this23, new SubApi(), function (state, subState) {
		...
		it('can be used to link an api to a redux store', function () {
			...
			var MyApi = function (_Api24) {
				...
				function MyApi(state) {
					...
					_this25.reducerCalled = 0;
					_this25.nested = (0, _reduxApis.link)(_this25, new SubApi());
					_this25.setHandler('TEST', function (state, action) {
		...
		it('ignores the optional `link` parameter when the parent is a redux store', function () {
			var expected = 'wow a custom state link!';
			var myApi = new _reduxApis.Api({ custom: expected });
			var store = (0, _redux.createStore)(myApi.reducer);
			(0, _reduxApis.link)(store, myApi, function (state, subState) {
				return subState ? state.custom = subState : state.custom;
			});
			(0, _chai.expect)(myApi.getState()).to.have.a.property('custom');
			(0, _chai.expect)(myApi.getState().custom).to.equal(expected);
		});
		it('can be used to index state objects into a parent array', function () {
			...
			var MyApi = function (_Api25) {
				...
				function MyApi() {
					...
					_this26.first = (0, _reduxApis.link)(_this26, new _reduxApis.Api('1st'), indexLink(0));
					_this26.second = (0, _reduxApis.link)(_this26, new _reduxApis.Api('2nd'), indexLink(1));
					_this26.third = (0, _reduxApis.link)(_this26, new _reduxApis.Api('3rd'), indexLink(2));
					return _this26;
				}
