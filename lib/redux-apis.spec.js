...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Api', function () {
		...
		describe('.constructor(state)', function () {
			...
			it('accepts a state slice', function () {
		...
		describe('.connector(state, ownProps)', function () {
			var MyApi = function (_Api22) {
				...
				function MyApi(state) {
					...
					Object.defineProperty(_this22, 'state', { enumerable: true,
						get: function get() {
							return _this22.getState().state;
						}
					});
					return _this22;
				}
			...
			it('returns an object with sub-objects for nested Apis, that change identity when the nested Api\'s state changes.', function () {
				var SubApi = function (_Api23) {
					_inherits(SubApi, _Api23);
					...
					function SubApi() {
						...
						var _this23 = _possibleConstructorReturn(this, Object.getPrototypeOf(SubApi).call(this, state));
	
						_this23.setHandler('SET', function (state, _ref) {
							var payload = _ref.payload;
							return _extends({}, state, { value: payload });
						});
						Object.defineProperty(_this23, 'value', { enumerable: true, get: function get() {
								return _this23.getState().value;
							} });
						return _this23;
					}
				...
				var ApiWithSubs = function (_Api24) {
					_inherits(ApiWithSubs, _Api24);
	
					function ApiWithSubs(state) {
						_classCallCheck(this, ApiWithSubs);
	
						var _this24 = _possibleConstructorReturn(this, Object.getPrototypeOf(ApiWithSubs).call(this, state));
	
						_this24.sub = (0, _reduxApis.link)(_this24, new SubApi());
						return _this24;
					}
			...
			it('can be used in combination with the @connect decorator from react-redux', function () {
				...
				var MyApi = function (_Api25) {
					_inherits(MyApi, _Api25);
					...
					function MyApi() {
						...
						var _this25 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
						Object.defineProperty(_this25, 'message', { enumerable: true,
							get: function get() {
								return _this25.getState().message;
							}
						});
						return _this25;
					}
	...
	describe('link(parent, child, link/*(parentState,childState)*/ )', function () {
		it('can be used to link a child api to a parent api', function () {
			var SubApi = function (_Api26) {
				_inherits(SubApi, _Api26);
			...
			var MyApi = function (_Api27) {
				_inherits(MyApi, _Api27);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this28 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this28.nested = (0, _reduxApis.link)(_this28, new SubApi());
					return _this28;
				}
		...
		it('results in actions on the child api to be dispatched via the parent api', function () {
			...
			var SubApi = function (_Api28) {
				_inherits(SubApi, _Api28);
			...
			var MyApi = function (_Api29) {
				_inherits(MyApi, _Api29);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this30 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this30.nested = (0, _reduxApis.link)(_this30, new SubApi());
					(0, _chai.expect)(_this30.nested).to.be.an.instanceOf(SubApi);
					return _this30;
				}
		...
		it('accepts an optional `link` function to link the child state to the parent state', function () {
			var SubApi = function (_Api30) {
				_inherits(SubApi, _Api30);
			...
			var MyApi = function (_Api31) {
				_inherits(MyApi, _Api31);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this32 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this32.nested = (0, _reduxApis.link)(_this32, new SubApi(), function (state, subState) {
		...
		it('can be used to link an api to a redux store', function () {
			var SubApi = function (_Api32) {
				_inherits(SubApi, _Api32);
			...
			var MyApi = function (_Api33) {
				_inherits(MyApi, _Api33);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this34 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this34.reducerCalled = 0;
					_this34.nested = (0, _reduxApis.link)(_this34, new SubApi());
					_this34.setHandler('TEST', function (state, action) {
		...
		it('can be used to index state objects into a parent array', function () {
			...
			var MyApi = function (_Api34) {
				...
				function MyApi() {
					...
					_this35.first = (0, _reduxApis.link)(_this35, new _reduxApis.Api('1st'), indexLink(0));
					_this35.second = (0, _reduxApis.link)(_this35, new _reduxApis.Api('2nd'), indexLink(1));
					_this35.third = (0, _reduxApis.link)(_this35, new _reduxApis.Api('3rd'), indexLink(2));
					return _this35;
				}
	...
	describe('apiLink(parentState, childState)', function () {
		it('is used as the default link from a child api to a parent api', function () {
			var SubApi = function (_Api35) {
				_inherits(SubApi, _Api35);
			...
			var MyApi = function (_Api36) {
				_inherits(MyApi, _Api36);
	
				function MyApi(state) {
					_classCallCheck(this, MyApi);
	
					var _this37 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this37.nested = (0, _reduxApis.link)(_this37, new SubApi());
					return _this37;
				}
	...
	describe('namedLink(name)', function () {
		...
		it('it can be used to customize the state link between a parent and child api', function () {
			...
			var SubApi = function (_Api37) {
				_inherits(SubApi, _Api37);
			...
			var MyApi = function (_Api38) {
				_inherits(MyApi, _Api38);
				...
				function MyApi() {
					...
					var _this39 = _possibleConstructorReturn(this, Object.getPrototypeOf(MyApi).call(this, state));
	
					_this39.nested = (0, _reduxApis.link)(_this39, new SubApi(), customLink);
					return _this39;
				}
	...
	var Api = exports.Api = function () {
		...
		_createClass(Api, [{
			...
			value: function connector(state, ownProps) {
				...
				var result = currentState === this.connector.__prevState ? this.connector.__prevResult : _extends({}, this);
				for (var key in this) {
